...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.25]{Monty}\\
...
To use the LEAP in a web-browser I used LeapStrap \cite{leapstrap}, which is built on top of Bootrap and was easy to integrate into the project.

\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.60]{leapstrap}
\caption{LeapStrap Code Used to Implement the LEAP Motion Controller in the Browser.}
\label{leapstrap}
\end{center}
\end{figure}

Once the LEAP was enabled for Jellibeans I was able to test the application with users to gather feedback. 

\subsubsection{Using the LEAP with Jellibeans.}
\begin{figure}[H]
\begin{center}
