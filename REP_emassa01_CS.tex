...
Out of the 40 queries in total, considering the top 3 results from Google (for comparison with Jellibeans), Jellibeans showed a modest improvement in precision rate see Figure ~\ref{result1}.
\begin{figure}[H]
\begin{center}
\includegraphics[scale=1]{Result1}
\caption{Precision for Jellibeans versus other search tool used by participants. Y axis represents search queries retrieved out of a total of 40.}
\label{result1}
\end{center}
\end{figure}
