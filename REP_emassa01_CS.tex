...
\vspace{5mm}
Manual testing for JavaScript included working with the JavaScript Console  \cite{javascripttesting}, I also used JSfiddle \cite{jsfiddle}. This was particularly useful to ensure the code was error-free. This tools also enabled me to see how well the JavaScript code integrated with the HTML code and CSS. JSLint  \cite{jslint} was another useful JavaScript testing tool used in the current project, to solely test JavaScript code. The program scans JavaScript code looking for errors, and when it finds one, it returns a message and location of the error in the code.

\vspace{5mm}
After manual verification was satisfied, automated verification of the JavaScript tests were run using QUnit \cite{qunit}. QUnit is a JavaScript Unit test framework used to test JavaScript, including, JQuery.

\vspace{5mm}
Finally, regression tests were run after unit testing, including testing with real users to evaluate the efficiency of the system as a whole. This next phase of testing is considered in Section ~\ref{usertesting} of this report.
